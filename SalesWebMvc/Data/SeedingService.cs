...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        //quando um SeedingService for criado vai receber automaticamente ima instancia do context
        ...
        //responsavel por fazer o seed à base de dados
        public void Seed()
        {
            //vai verificar se ja existir alguma coisa na base de dados, se sim nao faz nada
            if ( _context.Department.Any() || _context.Seller.Any() || _context.SalesRecord.Any())
            {
                return; //DB has been seeded
            }
            //instanciar os objetos para irem para a base de dados (code-first)
            ...
            //mandar adicionar na base de dados com o entity framework
            ...
            //para chamar a seed, ir ao startup
